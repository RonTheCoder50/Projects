...
function dynamicUpdation(categoryName, jsonData) {
    ...
    for(let item of jsonData) {
        ...
        li.classList.add("w-full", "min-w-[250px]", "lg:max-w-[300px]", "xl:max-w-[330px]", "bg-white", "shadow-sm","hover:shadow-md", "hover:scale-[1.02]", "transition-all", "delay-75", "duration-100", "ease-linear", "rounded-md", "flex", "flex-col", "p-1", "mx-auto", "product-item", "overflow-x-hidden", ".ly");
...
function productCard() {
    ...
    mainList.addEventListener("click", (e) => {
        ...
        console.log(e.target.closest(".itemList_"));

        const li = e.target.closest("ul li");
        console.log(li);
